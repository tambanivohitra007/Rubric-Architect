      ...
      <div className="rubric-container bg-white p-8 rounded-xl shadow-lg border border-slate-200 print:shadow-none print:border-0 print:p-0">
        <div className="mb-8 border-b border-slate-100 pb-6">
          ...
          <div className="flex items-center gap-6 text-slate-500">
            <span className="bg-slate-100 px-3 py-1 rounded-full text-sm font-medium text-slate-700">{data.courseName}</span>
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr>
              <th className="p-3 border-b-2 border-slate-800 w-1/5 font-bold text-slate-900">Criteria</th>
               ...
               return (
                <tr key={row.id} className="break-inside-avoid">
                  <td className="p-4 border-b border-slate-200 bg-slate-50/50">
                    <div className="font-bold text-slate-800 text-sm mb-1">{criterion?.title}</div>
